...
`,[Pt(w("&","--n-merged-color: var(--n-color-modal);")),Rt(w("&","--n-merged-color: var(--n-color-popover);")),w("img",`
 ...
 align-items: center;
 justify-content: center;
 `,[co({top:"50%",originalTransform:"translateY(-50%)"})]),mn()]),N("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
